...
Chrome 웹페이지 안에서 돌아다니는 비둘기 확장 프로그램입니다. 비둘기는 페이지 위를 걷고, 뛰고, 날아오고, 모이를 먹고, 팝업에서 퇴근할 수 있습니다.
...
비둘기를 우클릭하면 모이 주기 메뉴가 열립니다.

- `모이 주기`: 버튼 옆에서 집중/쉬는 남은 시간을 볼 수 있고, 25분 집중 뒤 5분 쉬는 시간 동안 페이지 위에 모이를 놓으면 여러 비둘기가 화면 밖에서 몰려와 먹습니다.
